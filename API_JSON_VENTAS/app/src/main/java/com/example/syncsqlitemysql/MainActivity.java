    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSync.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sincronizar();
                Toast.makeText(MainActivity.this, "Sincronizacion realizada - No hay mas datos a sincronizar", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(etProducto.getText().toString().equals("") || etPrecio.getText().toString().equals("")) {
                    Toast.makeText(MainActivity.this, "Por favor llenar todos lo campos", Toast.LENGTH_SHORT).show();
                } else {
                    agregarLocal();
